...
<template>
  <form
    ...
    <input
      ...
      type="date"
      class="py-1 flex-initial px-4 text-[16px] text-white placeholder:text-white font-semibold placeholder:font-semibold bg-mist-900 rounded" />
    <input
      v-model="draftTaskPriority"
      type="text"
      class="w-8 p-1 pl-2.5 flex-initial text-[16px] text-white placeholder:text-white font-semibold placeholder:font-semibold bg-mist-900 rounded" />
    <button
      type="submit"
